angular.module('mvmsService', [])
  ...
  .factory('Shit', function(Tool, $document, Plat, Back, Move, $modal, $rootScope, swap, store, Tree, adjustNode) {
    ...
    return  {
      ...
      logs: function(s) {
        $modal.open({
          windowClass: 'logs',
          templateUrl: '/static/mvms/partials/logs.html',
      ...
      editNodes: function(s) {
        $modal.open({
          ...
          templateUrl: '/static/mvms/partials/editNodes.html',
      ...
      applyOthers: function(s) {
        $modal.open({
          ...
          templateUrl: '/static/mvms/partials/otherPlats.html',
      ...
      view: function(e) {
        ...
        $modal.open({
          ...
          templateUrl: '/static/mvms/partials/imageView.html',
  ...
  .factory('addVideo', function($modal, ListProvider, Back, $timeout) {
    return function(rec_cb, item) {
      $modal.open({
        windowClass: 'video',
        templateUrl: '/static/mvms/partials/addVideo.html',
        controller: function($scope, $http, $modalInstance) {
          $scope.search = {
            keyword: '',
            fee: -1,
